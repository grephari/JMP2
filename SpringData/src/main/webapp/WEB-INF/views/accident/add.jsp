	...
	<div class="container">
		...
		<form class="form-horizontal" id="accidentForm">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="accidentId" placeholder="200901BS70001" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Date/Time</label>
				<div class="col-sm-10">
					<p class="form-control-static text-muted">* (will be fill automatically)</p>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Longitude</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="longitude" placeholder="-0.20135" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Latitude</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="latitude" placeholder="51.51227" />
				</div>
			</div>
			<div class="form-group">
		...
		function() {
			$('#saveAccidentBtn').click(
				function() {
					...
					$.ajax({
						type : 'POST',
						url : 'roadaccidentmgmt/accidents',
